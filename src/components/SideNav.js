...
const SideNav = () => {
  ...
  return (
    <div class="fixed flex flex-col top-0 left-0 w-14 hover:w-64 md:w-64  dark:bg-gray-900 h-full text-white transition-all duration-300 border-none z-10 sidebar"  style={{
